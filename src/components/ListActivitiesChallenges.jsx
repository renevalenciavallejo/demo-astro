...
function ListActivitiesChallenges({activitiesChallenges}) {
    ...
    const filterTypesActivitiesChallenges = (typeActivityChallenge) => {
        ...
        const filteredActivitiesChallenges = activitiesChallenges.filter(activityChallenge => activityChallenge.activityType == typeActivityChallenge);
    ...
    return (
        ...
        <section className="bg-black w-full overflow-x-auto sm:px-10">
            <div className="flex space-x-4 p-4 sm:pl-10 sm:justify-center lg:justify-start md:justify-center pt-32 pt:mt-0">
                ...
                <div className="flex-shrink-0">
                    <button className="bg-transparent border border-gray-300 rounded-10 hover:text-black hover:bg-customYellow focus:bg-customYellow text-white font-bold py-1 px-3 rounded-full inline-flex items-center focus:text-black" 
                        onClick={() => { filterTypesActivitiesChallenges("Running");}}
                        onMouseEnter={() => {changeColorRunning("onMouseEnter");}}
                        onMouseLeave={() => {changeColorRunning("onMouseLeave");}}
                        onFocus={() => {changeColorRunning("onFocus");}}
                        onBlur={() => {changeColorRunning("onBlur");}}
                        key="Running">
                        <svg
                ...
                <div className="flex-shrink-0">
                    <button className="bg-transparent border border-gray-300 rounded-10 hover:text-black hover:bg-customPink focus:bg-customPink text-white font-bold py-1 px-3 rounded-full inline-flex items-center focus:text-black" 
                    onClick={() => {filterTypesActivitiesChallenges("Cycling");}} 
                    onMouseEnter={() => {changeColorCycling("onMouseEnter");}}
                    onMouseLeave={() => {changeColorCycling("onMouseLeave");}}
                    onFocus={() => {changeColorCycling("onFocus");}}
                    onBlur={() => {changeColorCycling("onBlur");}}
                    key="Cycling">
                    <svg className="group-632 w-5 h-5 ml-1 mr-1 transition-all duration-300 transform group-632-x" viewBox="0 0 26 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
...
export default ListActivitiesChallenges;